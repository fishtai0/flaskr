...
class APITestCase(unittest.TestCase):
    ...
    def test_token_auth(self):
        ...
        response = self.client.get(
            ...
            headers=self.get_api_headers('nash@example.com', 'cat'))
        self.assertTrue(response.status_code == 200)
        json_response = json.loads(response.data.decode('utf-8'))
    ...
    def test_unconfirmed_account(self):
        ...
        response = self.client.get(
            url_for('api.get_posts'),
            headers=self.get_api_headers('jake@example.com', 'cat'))
    ...
    def test_users(self):
        ...
        r = Role.select().where(Role.name == 'User').first()
        self.assertIsNotNone(r)
        u1 = User(email='lisa@example.com', username='lisa',
        ...
        self.assertTrue(response.status_code == 200)
        json_response = json.loads(response.data.decode('utf-8'))
        self.assertTrue(json_response['username'] == 'lisa')
        response = self.client.get(
    ...
    def test_comments(self):
        ...
        r = Role.select().where(Role.name == 'User').first()
        self.assertIsNotNone(r)
        u1 = User(email='dav@example.com', username='dav',
                  password='cat', confirmed=True, role=r)
        u2 = User(email='david@example.com', username='david',
                  password='dog', confirmed=True, role=r)
        u1.save()
        u2.save()
        ...
        response = self.client.post(
            ...
            headers=self.get_api_headers('david@example.com', 'dog'),
        ...
        response = self.client.get(
            url,
            headers=self.get_api_headers('dav@example.com', 'cat'))
        self.assertTrue(response.status_code == 200)
        json_response = json.loads(response.data.decode('utf-8'))
        self.assertTrue(json_response['url'] == url)
        self.assertTrue(json_response['body'] ==
